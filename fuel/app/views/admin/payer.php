...
<?= Asset::js('admin/payer.js');?>

<div class="container content">
	<div class="panel panel-default">
		<div class="panel-heading">
			<i class="fa fa-check-square-o"></i>&nbsp;振込先マスタ
			<span class="jquery-tooltip-class">
				...
				<span class="jquery-tooltip-content-class" style="display:none;">
					...
					<div class="jquery-tooltip-content-body">
						振込先を設定する画面です。<br/>
						振込先を登録、更新、削除することができます。<br/>
						また登録された振込先の一覧を表示することができます。<br/>
					</div>
				</span>
			</span>
		</div>
		...
		<div class="panel-body">
			...
			<form action="<?= Uri::create("admin/payer/registered") ?>" method="POST" class="form-horizontal" role="form">
				<div class="form-group">
					<label class="control-label" for="payer_id">No：</label>
					<div class="form-control-box">
						<input type="text" name="payer_id" class="form-control" id="payer_id" value="<?= $payer->id ?>" readonly="readonly" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label" for="payer_name">振込先名：</label>
					<div class="form-control-box">
						<input type="text" name="payer_name" class="form-control" id="payer_name" placeholder="" maxlength="50" value="<?= $payer->payer_name ?>" />&nbsp;※
					</div>
				</div>
				<div class="form-group">
					<label class="control-label" for="payer_url">振込先リンク：</label>
					<div class="form-control-box">
						<input type="text" name="payer_url" class="form-control" id="payer_url" placeholder="" maxlength="100" value="<?= $payer->payer_url ?>" />&nbsp;※
					</div>
				</div>
				<div class="form-group">
					<label class="control-label" for="payer_commission">手数料（%）：</label>
					<div class="form-control-box">
						<input type="text" name="payer_commission" class="form-control" id="payer_commission" maxlength="6" value="<?= $payer->payer_commission ?>" />&nbsp;※
					</div>
					<div class="form-control-box">
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title"><i class="fa fa-exclamation-circle"></i>&nbsp;振込先削除の確認</h5>
				</div>
				<div class="modal-body">振込先を削除しますか？</div>
				<div class="modal-footer">
					...
					<input type="hidden" id="payer_id_modal" value="" />
				</div>
			</div>
		</div>
	</div>

	<table class="table table-bordered table-hover common-list-table payer-list-table">
		<thead class="payer-list-thead">
			<tr>
				<td class="common-list-table-short">No.</td>
				<td class="common-list-table-short">振込先名</td>
				<td class="common-list-table-short">手数料（%）</td>
